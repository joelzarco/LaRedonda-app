...
//  LaRedonda
//
//  Created by sergio joel camacho zarco on 27/04/23.
//
...
class PaymentHandler : NSObject{
    ...
    static let supportedNetworks : [PKPaymentNetwork] = [.visa, .amex] // accepted credit cards
    // shippingMethod
    func shippingMethodCalculator() -> [PKShippingMethod]{
        let today  = Date()
        let calendar = Calendar.current
        
        let shippingStart = calendar.date(byAdding: .day, value: 5, to: today) // shipping expected from 5 to 10 days
        ...
        if let shippingEnd = shippingEnd, let shippingStart = shippingStart{
            ...
            // shipping is defined as freein this example
    ...
    func startPayment(products : [Product], total : Int, completion : @escaping PaymentCompletionHandler){
        ...
        paymentRequest.merchantIdentifier = "merchant.org.appuniversity.sweaterShopDemo"
